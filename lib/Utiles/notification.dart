...
class NotificationHelper {
  ...
  Future<void> initNotification() async {
    ...
    AndroidInitializationSettings("bright");
  ...
  Future<void> showSoundNotification() async {
    AndroidNotificationDetails androidDetails = AndroidNotificationDetails(
        ...
        priority: Priority.high, importance: Importance.high,sound: RawResourceAndroidNotificationSound("pikachu_sms"));
    DarwinNotificationDetails iosDetails = DarwinNotificationDetails();
    NotificationDetails notificationDetails =
    NotificationDetails(android: androidDetails, iOS: iosDetails);
    await notificationsPlugin.show(
        3, "New Notification Available", "Massage Box", notificationDetails);
  }
}
