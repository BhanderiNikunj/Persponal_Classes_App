...
import 'package:classes_app/Admin/AdminProfile/Controllor/AdminProfileControllor.dart';
...
class _AdminProfileScreenState extends State<AdminProfileScreen> {
  AdminProfileControllor profileControllor = Get.put(
    AdminProfileControllor(),
  );
